...
if st.button('Calcular'):
    ...
    if animais_por_hectare_atual > animais_por_hectare_suportado:
        ...
        st.success(f"O número de animais está adequado ao pasto. Há uma margem para adicionar até {animais_por_hectare_suportado - animais_por_hectare_atual:.0f} animais por hectare. Você precisará manejar o pasto novamente dentro de 40 dias")
